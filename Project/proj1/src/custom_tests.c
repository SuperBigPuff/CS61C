...
bool test_body_to_tail() {
  // TODO: Implement this function.
    ...
    if (!assert_true("output_4", output_4 == 'd')) {
      return false;
    }
  return true;
}
...
bool test_get_next_row() {
  // TODO: Implement this function.
  char testcase_1 = 'v';
  unsigned int output_1 = get_next_row(0, testcase_1);
  if (!assert_true("output_1", output_1 == 1)) {
    return false;
  }

  char testcase_2 = 's';
  unsigned int output_2 = get_next_row(0, testcase_2);
  if (!assert_true("output_2", output_2 == 1)) {
    return false;
  }

  char testcase_3 = 'S';
  unsigned int output_3 = get_next_row(0, testcase_3);
  if (!assert_true("output_3", output_3 == 1)) {
    return false;
  }

  char testcase_4 = '^';
  unsigned int output_4 = get_next_row(1, testcase_4);
  if (!assert_true("output_4", output_4 == 0)) {
    return false;
  }

  char testcase_5 = 'w';
  unsigned int output_5 = get_next_row(1, testcase_5);
  if (!assert_true("output_5", output_5 == 0)) {
    return false;
  }

  char testcase_6 = 'W';
  unsigned int output_6 = get_next_row(1, testcase_6);
  if (!assert_true("output_6", output_6 == 0)) {
    return false;
  }
...
bool test_get_next_col() {
  // TODO: Implement this function.
  char testcase_1 = '>';
  unsigned int output_1 = get_next_col(0, testcase_1);
  if (!assert_true("output_1", output_1 == 1)) {
    return false;
  }

  char testcase_2 = 'd';
  unsigned int output_2 = get_next_col(0, testcase_2);
  if (!assert_true("output_2", output_2 == 1)) {
    return false;
  }

  char testcase_3 = 'D';
  unsigned int output_3 = get_next_col(0, testcase_3);
  if (!assert_true("output_3", output_3 == 1)) {
    return false;
  }

  char testcase_4 = '<';
  unsigned int output_4 = get_next_col(1, testcase_4);
  if (!assert_true("output_4", output_4 == 0)) {
    return false;
  }

  char testcase_5 = 'a';
  unsigned int output_5 = get_next_col(1, testcase_5);
  if (!assert_true("output_5", output_5 == 0)) {
    return false;
  }

  char testcase_6 = 'A';
  unsigned int output_6 = get_next_col(1, testcase_6);
  if (!assert_true("output_6", output_6 == 0)) {
    return false;
  }
